...
const HomePage = ({ navigation }: any) => {
  ...
  const handleUpload = async () => {
    try {
      const _options: any = {};
      let result: any = {};
      result = await launchImageLibrary({ ..._options, includeBase64: false });
        ...
        <View style={styles.container}>
          ...
          <View style={styles.centerAlignmentContainer}>
            ...
            <View style={styles.bracketsContainer}>
              ...
              {/* Center text */}
              <CustomText style={styles.focusText}>
                Place the plant in focus
              </CustomText>
          ...
          <FixedBottomSheetModal
            ...
            children={<Help onClose={handleCloseModal}></Help>}
